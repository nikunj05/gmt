...
function ganesh_enqueue_scripts() {
...
add_action('wp_enqueue_scripts', 'ganesh_enqueue_scripts');
...
function product_category_shortcode($atts) {
    global $post;
    ...
    $args = array(
        'post_type'      => 'product',
        'posts_per_page' => 100,
        'post__not_in'   => is_singular('product') ? array($post->ID) : [],
        'tax_query'      => array(
            array(
...
add_shortcode('product_list', 'product_category_shortcode');



/* =========================
   TOOLS CUSTOM POST TYPE
========================= */
...
========================= */
function create_tools_taxonomy() {
...
add_action('init', 'create_tools_taxonomy');


/* =========================
   TOOL SLIDER SHORTCODE
========================= */
function tool_slider_shortcode($atts) {

    $atts = shortcode_atts(array(
        'category' => '',
        'posts'    => -1, // show all tools
    ), $atts);
    ...
    echo '<div class="tools-slider">'; // slick target
